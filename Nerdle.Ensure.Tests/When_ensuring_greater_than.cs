...
namespace Nerdle.Ensure.Tests
{
    ...
    public class When_ensuring_greater_than
    {
        ...
        public class On_a_value
        {
            ...
            {
                Action ensuring = () => Ensure.ValueOf(1).GreaterThan(0);
            ...
            {
                Action ensuring = () => Ensure.ValueOf(1).GreaterThan(1);
            ...
            {
                Action ensuring = () => Ensure.ValueOf(1).GreaterThan(2);
                ensuring.ShouldThrow<Exception>();
            }
            ...
            {
                Action ensuring = () => Ensure.ValueOf(1).GreaterThan(1, "foo");
            ...
            {
                Action ensuring = () => Ensure.ValueOf(1).GreaterThan(1, _ => new IndexOutOfRangeException("bar"));
