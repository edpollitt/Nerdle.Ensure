...
namespace Nerdle.Ensure.Tests
{
    ...
    public class When_ensuring_less_than_or_equal_to
    {
        ...
        public class On_a_value
        {
            ...
            {
                Action ensuring = () => Ensure.ValueOf(-1).LessThanOrEqualTo(0);
            ...
            {
                Action ensuring = () => Ensure.ValueOf(1).LessThanOrEqualTo(1);
                ensuring.ShouldNotThrow();
            }
            ...
            {
                Action ensuring = () => Ensure.ValueOf(2).LessThanOrEqualTo(1);
            ...
            {
                Action ensuring = () => Ensure.ValueOf(2).LessThanOrEqualTo(1, "foo");
            ...
            {
                Action ensuring = () => Ensure.ValueOf(2).LessThanOrEqualTo(1, _ => new IndexOutOfRangeException("bar"));
