...
namespace Nerdle.Ensure.Tests
{
    ...
    public class When_ensuring_less_than
    {
        ...
        public class On_a_value
        {
            ...
            {
                Action ensuring = () => Ensure.Value(-1).LessThan(0);
            ...
            {
                Action ensuring = () => Ensure.Value(0).LessThan(0);
            ...
            {
                Action ensuring = () => Ensure.Value(1).LessThan(1);
            ...
            {
                Action ensuring = () => Ensure.Value(1).LessThan(1, "foo");
            ...
            {
                Action ensuring = () => Ensure.Value(1).LessThan(1, _ => new IndexOutOfRangeException("bar"));
