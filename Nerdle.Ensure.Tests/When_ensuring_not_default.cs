...
namespace Nerdle.Ensure.Tests
{
    ...
    public class When_ensuring_not_default
    {
        ...
        public class On_a_value
        {
            ...
            {
                Action ensuring = () => Ensure.ValueOf(1).NotDefault();
            ...
            {
                Action ensuring = () => Ensure.ValueOf(0).NotDefault();
            ...
            {
                Action ensuring = () => Ensure.ValueOf(Guid.Empty).NotDefault();
            ...
            {
                Action ensuring = () => Ensure.ValueOf(DateTime.MinValue).NotDefault("foo");
            ...
            {
                Action ensuring = () => Ensure.ValueOf(0).NotDefault(_ => new IndexOutOfRangeException("bar"));
