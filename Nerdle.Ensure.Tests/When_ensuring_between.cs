...
namespace Nerdle.Ensure.Tests
{
    ...
    public class When_ensuring_between
    {
        ...
        public class On_a_value
        {
            ...
            {
                Action ensuring = () => Ensure.ValueOf(1).Between(1, 100);
            ...
            {
                Action ensuring = () => Ensure.ValueOf(100).Between(1, 100);
                ensuring.ShouldNotThrow();
            }
            ...
            {
                Action ensuring = () => Ensure.ValueOf(0).Between(-1, 1);
                ensuring.ShouldNotThrow();
            }
            ...
            {
                Action ensuring = () => Ensure.ValueOf(0).Between(1, 10);
            ...
            {
                Action ensuring = () => Ensure.ValueOf(11).Between(1, 10);
            ...
            {
                Action ensuring = () => Ensure.ValueOf(1).Between(-1, 0);
            ...
            {
                Action ensuring = () => Ensure.ValueOf(1).Between(-1, 0, "foo");
            ...
            {
                Action ensuring = () => Ensure.ValueOf(1).Between(10, 100, _ => new FieldAccessException("bar"));
